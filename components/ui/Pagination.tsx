        ...
        {getPageNumbers().map((page, index) => {
          ...
          return (
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium rounded-lg transition-all duration-fast ${
                currentPage === page
                  ? 'bg-brand text-white'
      ...
      {showItemsPerPage && onItemsPerPageChange && (
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-2 py-1 text-sm border border-[var(--color-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-brand"
          >
