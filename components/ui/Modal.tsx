  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Footer */}
        {footer && (
          <div className="px-6 py-4 border-t border-[var(--color-border-subtle)] bg-[var(--color-page-bg)] rounded-b-2xl flex-shrink-0">
            {footer}
          </div>
        )}
      </div>
...
export function ModalFooter({ children, className = '' }: ModalFooterProps) {
  return (
    <div
      className={`px-6 py-4 border-t border-[var(--color-border-subtle)] bg-[var(--color-page-bg)] flex items-center justify-end gap-3 ${className}`}
    >
      {children}
    </div>
  );
